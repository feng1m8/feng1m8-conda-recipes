...
cl %RECIPE_DIR%\ar5ivist.cxx %LIBRARY_PREFIX%\symlink-exe.c -I%BUILD_PREFIX%\Library\include\libxml2 -I%BUILD_PREFIX%\Library\include -DRELATIVE_PATH -std:c++17 -EHsc -O1 -Os -Gy -MD -link -FIXED -out:%LIBRARY_BIN%\ar5ivist.exe %BUILD_PREFIX%\Library\lib\libxml2.lib
